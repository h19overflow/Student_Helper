...
sudo docker run -d \
  ...
  -e POSTGRES_PASSWORD="I3jTntbvJ[fX4QtFy_Q#C#YVgBlg" \
  ...
  -e GOOGLE_API_KEY="AIzaSyAaf1Mgs4NbCr8zyOF148ktLee23wxaNxs" \
  -e LANGFUSE_SECRET_KEY="sk-lf-46301d58-8cdb-4737-9182-42baf6f1df4f" \
  -e LANGFUSE_PUBLIC_KEY="pk-lf-27e8d292-1300-4043-9301-ccd5913c6ee7" \
  -e LANGFUSE_BASE_URL="https://cloud.langfuse.com" \
  575734508049.dkr.ecr.ap-southeast-2.amazonaws.com/student-helper-dev-backend:latest
